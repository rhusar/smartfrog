...
echo %SFJVM% %SFCMDPARAMETERS% %SFLIBRARYPATH% org.smartfrog.SFSystem -a \"%APPNAME%\":DEPLOY:\"%3\"::%1: -e
%SFJVM% %SFCMDPARAMETERS% %SFLIBRARYPATH% org.smartfrog.SFSystem -a \"%APPNAME%\":DEPLOY:\"%3\"::%1: -e

GOTO end
:execute
if (%5)==() goto usage
echo %SFJVM% %SFCMDPARAMETERS% %SFLIBRARYPATH% org.smartfrog.SFSystem -a \"%APPNAME%\":DEPLOY:\"%3\"::%1: -p %5 -e
